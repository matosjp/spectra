...
- **Dynamic MADYS Model & Filter Engine** — dynamically queries all available evolutionary models (`bhac15`, `parsec`, `mist`, `baraffe15`, `baraffe98`, `siess2000`, `ames-cond`, `atmo2020`, etc.), automatically updating valid mass boundaries, age slider ranges, and supported photometric filter lists (up to 127+ filters per model).
